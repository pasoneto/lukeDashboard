...
/* change directory here. Or use dynamic data table generated by SAS. In this case, rename it as "a"*/
data a;
	set '/home/u60894373/graf_data_pedro.sas7bdat';
run;

/* Generates json file */
/* change directory here */
proc json out="/home/u60894373/json.txt" pretty;
	export a / nosastags;
run;
...
data _null_;
  /* change directory here */
    ...
    put '  <div class="column graphsBox" style="background-color:#ddd;">';
    put '    Graphs';
    put '    <button id="buttonRender">Render graphs</button>';
    put '    <div class="row">';
    put '      <div class="column graphBox" id="box"></div>';
    put '      <div class="column graphBox" id="box1"></div>';
    put '    </div>';
    put '    <div class="row">';
    put '      <div class="column graphBox3" id="box2"></div>';
    put '      <div class="column graphBox3" id="box3"></div>';
    put '      <div class="column graphBox3" id="box4"></div>';
    put '    </div>';
    put '  </div>';
    put '</div>';
...
data _null_;
  /* change directory here */
	infile "/home/u60894373/json.txt";
	input;
  /* change directory here */
	file "/home/u60894373/test.txt" mod;
	put _infile_;
run;
...
data _null_;
  /* change directory here */
	file "/home/u60894373/test.html";
  /* change directory here */
	infile "/home/u60894373/test.txt";
	input;
	put _infile_;
run;
